            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-4 form-group">
                    ...
                    <input type="file"
                           ...
                           v-validate="'size:3072|ext:jpg,pdf,jpeg,gif,tiff'">
            ...
            const dict = {
                custom: {
                    document: {
                        ...
                        size: 'Тип загруженного файла не поддерживается. Загрузите, пожалуйста, jpg, gif, tiff или pdf файл. Размер файла должен составлять не более 3мб'
                    },
                    date: {
