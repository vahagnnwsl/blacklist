<form method="POST" action="{{ route('register') }}" class="mt-3">
    ...
    <div class="form-group row">
        <label for="advertising_number_1" class="col-md-4 col-form-label text-md-right">Рекламный номер по вопросу
            аренды </label>
    ...
    <div class="form-group row">
        <label for="passport_1" class="col-md-4 col-form-label text-md-right">Паспорт * </label>

        <div class="col-md-6">
            <input id="passport_1" type="text" class="form-control @error('passport') is-invalid @enderror"
                   name="passport">
    ...
    <div class="form-group row">
        <label for="inn_1" class="col-md-4 col-form-label text-md-right">ИНН * </label>

        <div class="col-md-6">
            <input id="inn_1" type="text" class="form-control @error('inn') is-invalid @enderror" name="inn">
