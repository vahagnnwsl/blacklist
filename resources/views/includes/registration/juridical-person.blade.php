<form method="POST" action="{{ route('register') }}" class="mt-3">
    ...
    <div class="form-group row">
        <label for="full_name_1" class="col-md-4 col-form-label text-md-right">ОГРН *</label>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <input id="full_name_1" type="file" class="form-control @error('full_name') is-invalid @enderror"
                   name="natural[full_name]">
            <small class="form-text text-muted text-right">Свидетельство о внесении юридического лица в ЕГРЮЛ, о постановке на налоговый учет (с ИНН)</small>
